...
<div id="page">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="bordered" >
        ...
        <tr>
            ...
            <td class="label">INV#:</td><td class="centered-blue" style="width: 20%;">{{ $facilityInfo->contract_number }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="label">Complete Invoice Date</td><td class="centered-blue">To be entered by Contract Manager</td>
        </tr>
        <tr>
            <td colspan="4" class="burgundy separator"></td>
        </tr>
        <tr>
            ...
            <td class="label">Cumulative Nonsecure Bed Days YTD:</td><td class="centered-blue"></td>
        </tr>
        <tr>
