                                ...
                                <div class="card">
                                    <header class="card-header">
                                        <p class="card-header-title">
                                            <a href="{{ route('resident.show', ['id' => $resident->id]) }}">{{ ucfirst($resident->last_name) }}, {{ ucfirst($resident->first_name) }} {{ strtoupper($resident->middle_initial) }}</a><span class="column has-text-right doc-number">{{ $resident->document_number }}</span>
                                        </p>
                                    </header>
